insert into airports (airport_name) values ('Qom'), ('Tex'), ('USA'), ('UK');

insert into airlines (airline_name) values ('IranAir'), ('KishAir'), ('Pars'), ('Aseman');
...
('Fateme', 'Rezaeian', 'fateme@email.com', '1111'),
('Mohammad', 'Salehi', 'h.mammad@email.com', '1111'),
('Mahdi', 'Kaveh', 'kaveh@email.com', '1111'),
('John', 'Doe', 'john@email.com', '1111'),
('Jane', 'Doe', 'jane@email.com', '1111');
...
insert into sources (date_time, airport_id) values ('2022-01-15 9:30:34', 2);
insert into destinations (date_time, airport_id) values ('2021-01-15 13:35:56', 3);
insert into flights (flight_code, source_id, destination_id, airplane_id, fare, capacity, status)
...
insert into sources (date_time, airport_id) values ('2022-01-15 9:30:34', 4);
insert into destinations (date_time, airport_id) values ('2022-01-15 13:35:56', 1);
insert into flights (flight_code, source_id, destination_id, airplane_id, fare, capacity, status)
...
insert into sources (date_time, airport_id) values ('2022-01-15 9:30:34', 1);
insert into destinations (date_time, airport_id) values ('2022-01-15 13:35:56', 3);
insert into flights (flight_code, source_id, destination_id, airplane_id, fare, capacity, status)
...
insert into sources (date_time, airport_id) values ('2022-01-14 11:30:34', 4);
insert into destinations (date_time, airport_id) values ('2022-01-14 13:35:56', 3);
insert into flights (flight_code, source_id, destination_id, airplane_id, fare, capacity, status)
values ('9FF9', 9, 9, 3, 68.50, 10, 'ON_TIME');

insert into sources (date_time, airport_id) values ('2022-01-15 9:30:34', 3);
insert into destinations (date_time, airport_id) values ('2022-01-15 13:35:56', 1);
insert into flights (flight_code, source_id, destination_id, airplane_id, fare, capacity, status)
...
insert into sources (date_time, airport_id) values ('2022-01-14 11:30:34', 3);
insert into destinations (date_time, airport_id) values ('2022-01-14 13:35:56', 1);
insert into flights (flight_code, source_id, destination_id, airplane_id, fare, capacity, status)
...
('2022-01-14 15:20:23', 'CANCELLED', 3, 7),
('2022-01-14 15:20:23', 'CANCELLED', 3, 8),

('2022-01-14 15:20:23', 'ACTIVE', 4, 7),
('2022-01-14 15:20:23', 'ACTIVE', 4, 8),
('2022-01-14 15:20:23', 'CANCELLED', 4, 5),
('2022-01-14 15:20:23', 'CANCELLED', 4, 6);
