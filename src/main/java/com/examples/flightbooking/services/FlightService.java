...
public class FlightService
{
    ...
    public Set<Flight> getFlightsByCity(Integer sourceId, Integer destinationId)
    {
        if(Util.validateNumber(sourceId) && Util.validateNumber(destinationId))
        {
            return flightRepository.findFlightsByCity(sourceId, destinationId);
        }
        return null;
    }
